...
def resize_container(container, y=None, x=None): # Container should get smaller From the top to bottom. Items should get smaller from the top-right corner to left bottom.
    pass
